...
function Introduction(){
    return (
            <>
                ...
                <h1>Introduction</h1>
                <br/>
                <p>Hi! I'm Rachel, a Software Engineering Degree Apprentice working for Vodafone. I have a strong preference for front-end development work, but I've also got experience building backends using languages like Python, SQL and PHP. 
